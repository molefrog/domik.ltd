...
So when Ash was offered to a position on the other side of the continent lecturing in a two-year
course at a {<TV video="-7OE6bDfM2M" from="0:07">prestigious school</TV>} specialising in
"production technology for highly complex industrial cakes," we were delighted for him. Until he ran
it by us, he'd had his doubts, but we were able to convince him it was a once-in-a-lifetime
opportunity.
...
offering modular baths. Options like: steam pressure, the layout of the pools and the passageways
...
iventions did not exactly fly off the shelves, and at some points I felt like I'd failed and should
...
export const CreditsSection = () => {
  const [revealTitles, setRevealTitles] = useState(true);
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Credits.Credits>
        <Spoiler reveal={revealTitles}>To my friend Tikhon.</Spoiler>
        <Credits.Columns>
          <Credits.Credit title={<Spoiler reveal={revealTitles}>Story, design, development</Spoiler>}>
            <Spoiler reveal={revealTitles}>
              <EyedLink href="https://molefrog.com">Alexey Taktarov</EyedLink>
            </Spoiler>
          </Credits.Credit>
          <Credits.Credit title={<Spoiler reveal={revealTitles}>Illustrations, character design</Spoiler>}>
            <Spoiler reveal={revealTitles}>
          ...
          <Credits.Credit title={<Spoiler reveal={revealTitles}>English translation</Spoiler>}>
            <Spoiler reveal={revealTitles}>
              <EyedLink href="https://www.instagram.com/susannah_garden/">Susannah Garden</EyedLink>
            </Spoiler>
          </Credits.Credit>
          <Credits.Credit title={<Spoiler reveal={revealTitles}>Font used</Spoiler>}>
            <Spoiler reveal={revealTitles}>
              <EyedLink href="https://type.today/en/grato_marker">Grato Marker</EyedLink>
            </Spoiler>
          </Credits.Credit>
          <Credits.Credit title={<Spoiler reveal={revealTitles}>UI Sounds</Spoiler>}>
            <Spoiler reveal={revealTitles}>
